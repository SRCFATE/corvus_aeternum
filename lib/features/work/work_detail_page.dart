...
import '../../shared/widgets/add_to_collection_sheet.dart';
...
class _WorkDetailPageState extends State<WorkDetailPage> {
  ...
  void _showAddToCollection() {
    final work = _work;
    if (work != null) {
      showAddToCollection(context, work: work, profileId: _getUserId());
    }
  }
  ...
  Widget _buildMainColumn(Work work, {required bool inSidebar}) {
    ...
    return Column(
      ...
      children: [
        ...
        if (context.watch<AuthProvider>().profile?.isAdmin == true &&
            work.isPublic &&
          ...
          TextButton.icon(
              ...
              label: const Text('Gestionar selección editorial')),
  ...
  Widget _buildSingleChapterCard(Work work, WorkChapter chapter) {
    return _ChapterCard(
      ...
      onTap: () => context.push('/work/${work.id}/chapter/0?resume=true'),
    );
  }
